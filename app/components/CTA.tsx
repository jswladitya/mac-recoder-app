            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="center" className="w-56 p-1.5 bg-zinc-950 border border-zinc-800 rounded-xl shadow-2xl">
                <DropdownMenuItem asChild className="rounded-lg">
                  <Link href="#" className="flex items-center gap-2.5 px-3 py-2.5 cursor-pointer hover:bg-zinc-900 duration-100 text-zinc-200 hover:text-white">
                    ...
                    <span className="font-semibold text-sm">Download for MAC</span>
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild className="rounded-lg">
                  <Link href="#" className="flex items-center gap-2.5 px-3 py-2.5 cursor-pointer hover:bg-zinc-900 duration-100 text-zinc-200 hover:text-white">
                    ...
                    <span className="font-semibold text-sm">Download for Windows</span>
                  </Link>
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
